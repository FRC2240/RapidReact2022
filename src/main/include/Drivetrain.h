...
class Drivetrain {
 public:
  ...
  static constexpr double kP = 1.650; //0.157; //2.77;                  // measured
  static constexpr auto   kS = 0.581_V; //0.27_V;                         // measured
  static constexpr auto   kV = 1.433 * 1_V * 1_s / 1_m;    // 1.53     // measured
  static constexpr auto   kA = 0.111 * 1_V * 1_s * 1_s / 1_m;  // 0.254 // measured

  units::meter_t kTrackWidth = 0.593_m; // 1.388? //0.657_m;                        // measured    
